...
bool gcString::operator ==(const char* s) const
{
    return data == s;
}

bool gcString::operator ==(const gcString& s) const
{
    return data == s.data;
}
...
gcString gcString::setw(int newlength, gcString flood)
{
    if(newlength==data.length())return (*this);
    if(flood=="")flood=" ";
#ifdef GCSTRING_IS_CBSTRING
...
gcString gcString::setrw(int newlength, gcString flood)
{
    if(newlength==data.length())return (*this);
    if(flood=="")flood=" ";
#ifdef GCSTRING_IS_CBSTRING
...
/*
int gcString::gcIsEqual(gcString s)
*/

int gcString::gcIsEqual(const gcString& s)
{
    if( this->data == s.data )return 0;
