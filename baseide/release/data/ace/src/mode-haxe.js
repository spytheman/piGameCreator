...
var HaxeHighlightRules = function() {
	...
	// Blame! some of these are TYPES and NOT KEYWORDS! I don't like these to be keywords!
	// and the function and the lists with these entities are exposed to the global scope so C++ can use them
	
	// lists moved to the top
