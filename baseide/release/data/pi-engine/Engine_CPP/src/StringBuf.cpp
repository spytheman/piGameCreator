...
{
HX_STACK_PUSH("StringBuf::new","StringBuf.hx",31);
{
	HX_STACK_LINE(31)
...
::String StringBuf_obj::toString( ){
	HX_STACK_PUSH("StringBuf::toString","StringBuf.hx",47);
	HX_STACK_THIS(this);
	HX_STACK_LINE(47)
...
{
		HX_STACK_PUSH("StringBuf::addChar","StringBuf.hx",43);
		HX_STACK_THIS(this);
		HX_STACK_ARG(c,"c");
		HX_STACK_LINE(43)
...
{
		HX_STACK_PUSH("StringBuf::addSub","StringBuf.hx",39);
		HX_STACK_THIS(this);
		HX_STACK_ARG(s,"s");
...
{
		HX_STACK_PUSH("StringBuf::add","StringBuf.hx",35);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_LINE(35)
