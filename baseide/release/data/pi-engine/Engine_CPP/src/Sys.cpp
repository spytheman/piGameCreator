...
{
		HX_STACK_PUSH("Sys::print","Sys.hx",28);
		HX_STACK_ARG(v,"v");
		HX_STACK_LINE(28)
		::__hxcpp_print(v);
	}
...
{
		HX_STACK_PUSH("Sys::println","Sys.hx",32);
		HX_STACK_ARG(v,"v");
		HX_STACK_LINE(33)
		::Sys_obj::print(v);
		HX_STACK_LINE(34)
...
::haxe::io::Input Sys_obj::_stdin( ){
	HX_STACK_PUSH("Sys::stdin","Sys.hx",37);
	HX_STACK_LINE(37)
...
::haxe::io::Output Sys_obj::_stdout( ){
	HX_STACK_PUSH("Sys::stdout","Sys.hx",41);
	HX_STACK_LINE(41)
...
::haxe::io::Output Sys_obj::_stderr( ){
	HX_STACK_PUSH("Sys::stderr","Sys.hx",45);
	HX_STACK_LINE(45)
...
int Sys_obj::getChar( bool echo){
	HX_STACK_PUSH("Sys::getChar","Sys.hx",49);
...
Array< ::String > Sys_obj::args( ){
	HX_STACK_PUSH("Sys::args","Sys.hx",53);
	HX_STACK_LINE(53)
	return ::__get_args();
}
...
::String Sys_obj::getEnv( ::String s){
	HX_STACK_PUSH("Sys::getEnv","Sys.hx",57);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(58)
...
{
		HX_STACK_PUSH("Sys::putEnv","Sys.hx",64);
		HX_STACK_ARG(s,"s");
		HX_STACK_ARG(v,"v");
		HX_STACK_LINE(64)
		::Sys_obj::put_env(s,v);
...
{
		HX_STACK_PUSH("Sys::sleep","Sys.hx",68);
...
bool Sys_obj::setTimeLocale( ::String loc){
	HX_STACK_PUSH("Sys::setTimeLocale","Sys.hx",72);
...
::String Sys_obj::getCwd( ){
	HX_STACK_PUSH("Sys::getCwd","Sys.hx",76);
	HX_STACK_LINE(76)
...
{
		HX_STACK_PUSH("Sys::setCwd","Sys.hx",80);
		HX_STACK_ARG(s,"s");
		HX_STACK_LINE(80)
		::Sys_obj::set_cwd(s);
	}
...
::String Sys_obj::systemName( ){
	HX_STACK_PUSH("Sys::systemName","Sys.hx",84);
	HX_STACK_LINE(84)
...
::String Sys_obj::escapeArgument( ::String arg){
	HX_STACK_PUSH("Sys::escapeArgument","Sys.hx",88);
...
int Sys_obj::command( ::String cmd,Array< ::String > args){
	HX_STACK_PUSH("Sys::command","Sys.hx",102);
...
{
		HX_STACK_PUSH("Sys::exit","Sys.hx",111);
...
Float Sys_obj::time( ){
	HX_STACK_PUSH("Sys::time","Sys.hx",115);
	HX_STACK_LINE(115)
...
Float Sys_obj::cpuTime( ){
	HX_STACK_PUSH("Sys::cpuTime","Sys.hx",119);
	HX_STACK_LINE(119)
...
::String Sys_obj::executablePath( ){
	HX_STACK_PUSH("Sys::executablePath","Sys.hx",123);
	HX_STACK_LINE(123)
...
::Hash Sys_obj::environment( ){
	HX_STACK_PUSH("Sys::environment","Sys.hx",127);
	HX_STACK_LINE(128)
