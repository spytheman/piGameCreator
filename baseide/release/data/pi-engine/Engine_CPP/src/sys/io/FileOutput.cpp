...
{
HX_STACK_PUSH("FileOutput::new","sys/io/FileOutput.hx",33);
{
	HX_STACK_LINE(33)
	this->__f = f;
}
...
int FileOutput_obj::tell( ){
	HX_STACK_PUSH("FileOutput::tell","sys/io/FileOutput.hx",58);
	HX_STACK_THIS(this);
	HX_STACK_LINE(58)
...
{
		HX_STACK_PUSH("FileOutput::seek","sys/io/FileOutput.hx",54);
		HX_STACK_THIS(this);
		HX_STACK_ARG(p,"p");
...
{
		HX_STACK_PUSH("FileOutput::close","sys/io/FileOutput.hx",49);
		HX_STACK_THIS(this);
		HX_STACK_LINE(50)
		this->super::close();
		HX_STACK_LINE(51)
...
{
		HX_STACK_PUSH("FileOutput::flush","sys/io/FileOutput.hx",45);
		HX_STACK_THIS(this);
		HX_STACK_LINE(45)
...
int FileOutput_obj::writeBytes( ::haxe::io::Bytes s,int p,int l){
	HX_STACK_PUSH("FileOutput::writeBytes","sys/io/FileOutput.hx",41);
	HX_STACK_THIS(this);
	HX_STACK_ARG(s,"s");
	HX_STACK_ARG(p,"p");
	HX_STACK_ARG(l,"l");
	struct _Function_1_1{
		inline static int Block( ::sys::io::FileOutput_obj *__this,::haxe::io::Bytes &s,int &p,int &l){
			HX_STACK_PUSH("*::closure","sys/io/FileOutput.hx",42);
			{
				HX_STACK_LINE(42)
				try{
					HX_STACK_LINE(42)
...
{
		HX_STACK_PUSH("FileOutput::writeByte","sys/io/FileOutput.hx",37);
		HX_STACK_THIS(this);
		HX_STACK_ARG(c,"c");
		HX_STACK_LINE(37)
		try{
