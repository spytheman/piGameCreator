...
Dynamic Lib_obj::load( ::String lib,::String prim,int nargs){
	HX_STACK_PUSH("Lib::load","cpp/Lib.hx",32);
...
Dynamic Lib_obj::loadLazy( Dynamic lib,Dynamic prim,int nargs){
	HX_STACK_PUSH("Lib::loadLazy","cpp/Lib.hx",44);
	HX_STACK_ARG(lib,"lib");
	HX_STACK_ARG(prim,"prim");
	HX_STACK_ARG(nargs,"nargs");
	HX_STACK_LINE(45)
			...
			Dynamic e = __e;{
				...
				switch( (int)(nargs)){
					case (int)0: {
						...
						Void run(){
							HX_STACK_PUSH("*::_Function_3_1","cpp/Lib.hx",49);
							{
								HX_STACK_LINE(49)
					...
					case (int)2: {
						...
						Void run(Dynamic _1,Dynamic _2){
							HX_STACK_PUSH("*::_Function_3_1","cpp/Lib.hx",50);
							HX_STACK_ARG(_1,"_1");
							HX_STACK_ARG(_2,"_2");
							{
								HX_STACK_LINE(50)
					...
					case (int)3: {
						...
						Void run(Dynamic _1,Dynamic _2,Dynamic _3){
							HX_STACK_PUSH("*::_Function_3_1","cpp/Lib.hx",51);
							HX_STACK_ARG(_1,"_1");
							HX_STACK_ARG(_2,"_2");
							HX_STACK_ARG(_3,"_3");
							{
					...
					case (int)4: {
						...
						Void run(Dynamic _1,Dynamic _2,Dynamic _3,Dynamic _4){
							HX_STACK_PUSH("*::_Function_3_1","cpp/Lib.hx",52);
							HX_STACK_ARG(_1,"_1");
							HX_STACK_ARG(_2,"_2");
							HX_STACK_ARG(_3,"_3");
							HX_STACK_ARG(_4,"_4");
...
{
		HX_STACK_PUSH("Lib::rethrow","cpp/Lib.hx",60);
...
{
		HX_STACK_PUSH("Lib::stringReference","cpp/Lib.hx",62);
		HX_STACK_ARG(inExp,"inExp");
		HX_STACK_LINE(62)
		hx::Throw (inExp);
	}
...
{
		HX_STACK_PUSH("Lib::print","cpp/Lib.hx",67);
		HX_STACK_ARG(v,"v");
		HX_STACK_LINE(67)
		::__hxcpp_print(v);
	}
...
Dynamic Lib_obj::haxeToNeko( Dynamic v){
	HX_STACK_PUSH("Lib::haxeToNeko","cpp/Lib.hx",75);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(75)
	return v;
}
...
Dynamic Lib_obj::nekoToHaxe( Dynamic v){
	HX_STACK_PUSH("Lib::nekoToHaxe","cpp/Lib.hx",83);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(83)
	return v;
}
...
{
		HX_STACK_PUSH("Lib::println","cpp/Lib.hx",89);
		HX_STACK_ARG(v,"v");
		HX_STACK_LINE(89)
		::__hxcpp_println(v);
	}
