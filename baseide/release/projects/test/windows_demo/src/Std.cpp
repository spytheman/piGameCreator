...
bool Std_obj::is( Dynamic v,Dynamic t){
	HX_STACK_PUSH("Std::is","Std.hx",27);
	HX_STACK_ARG(v,"v");
	HX_STACK_ARG(t,"t");
	HX_STACK_LINE(27)
...
::String Std_obj::string( Dynamic s){
	HX_STACK_PUSH("Std::string","Std.hx",31);
	HX_STACK_ARG(s,"s");
	HX_STACK_LINE(31)
...
int Std_obj::_int( Float x){
	HX_STACK_PUSH("Std::int","Std.hx",35);
	HX_STACK_ARG(x,"x");
	HX_STACK_LINE(35)
	return ::__int__(x);
}
...
Dynamic Std_obj::parseInt( ::String x){
	HX_STACK_PUSH("Std::parseInt","Std.hx",39);
	HX_STACK_ARG(x,"x");
	HX_STACK_LINE(39)
...
Float Std_obj::parseFloat( ::String x){
	HX_STACK_PUSH("Std::parseFloat","Std.hx",43);
	HX_STACK_ARG(x,"x");
	HX_STACK_LINE(43)
...
int Std_obj::random( int x){
	HX_STACK_PUSH("Std::random","Std.hx",47);
	HX_STACK_ARG(x,"x");
	HX_STACK_LINE(47)
