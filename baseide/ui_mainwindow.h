...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/resources/RES/ffficons/application_add.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionCreate_2D_scene->setIcon(icon11);
        actionCreate_3D_scene = new QAction(MainWindow);
        actionCreate_3D_scene->setObjectName(QString::fromUtf8("actionCreate_3D_scene"));
        QIcon icon12;
        icon12.addFile(QString::fromUtf8(":/resources/RES/ffficons/world_add.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionCreate_3D_scene->setIcon(icon12);
        ...
        QIcon icon13;
        icon13.addFile(QString::fromUtf8(":/resources/RES/ffficons/page_copy.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionClone_resource->setIcon(icon13);
        actionExport_resource = new QAction(MainWindow);
        actionExport_resource->setObjectName(QString::fromUtf8("actionExport_resource"));
        QIcon icon14;
        icon14.addFile(QString::fromUtf8(":/resources/RES/ffficons/disk.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionExport_resource->setIcon(icon14);
        actionAdd_class = new QAction(MainWindow);
        actionAdd_class->setObjectName(QString::fromUtf8("actionAdd_class"));
        QIcon icon15;
        icon15.addFile(QString::fromUtf8(":/resources/RES/ffficons/brick_add.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionAdd_class->setIcon(icon15);
        ...
        QIcon icon16;
        icon16.addFile(QString::fromUtf8(":/resources/RES/ffficons/script_add.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionAdd_global_function->setIcon(icon16);
        actionCreate_model = new QAction(MainWindow);
        actionCreate_model->setObjectName(QString::fromUtf8("actionCreate_model"));
        QIcon icon17;
        icon17.addFile(QString::fromUtf8(":/resources/RES/ffficons/car_add.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionCreate_model->setIcon(icon17);
        ...
        QIcon icon18;
        icon18.addFile(QString::fromUtf8(":/resources/RES/ffficons/disk_multiple.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionExport_some_resources->setIcon(icon18);
        ...
        QIcon icon19;
        icon19.addFile(QString::fromUtf8(":/resources/RES/ffficons/brick_go.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionCreate_class_template->setIcon(icon19);
        actionDefine_grid = new QAction(MainWindow);
        actionDefine_grid->setObjectName(QString::fromUtf8("actionDefine_grid"));
        QIcon icon20;
        icon20.addFile(QString::fromUtf8(":/resources/RES/ffficons/color_swatch.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionDefine_grid->setIcon(icon20);
        ...
        QIcon icon21;
        icon21.addFile(QString::fromUtf8(":/resources/RES/ffficons/cog_edit.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionEdit_application_settings->setIcon(icon21);
        actionCreate_Font = new QAction(MainWindow);
        actionCreate_Font->setObjectName(QString::fromUtf8("actionCreate_Font"));
        QIcon icon22;
        icon22.addFile(QString::fromUtf8(":/resources/RES/ffficons/font_add.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionCreate_Font->setIcon(icon22);
        actionShow_Main_page = new QAction(MainWindow);
        actionShow_Main_page->setObjectName(QString::fromUtf8("actionShow_Main_page"));
        QIcon icon23;
        icon23.addFile(QString::fromUtf8(":/resources/RES/ffficons/application_home.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionShow_Main_page->setIcon(icon23);
        action_Save = new QAction(MainWindow);
        action_Save->setObjectName(QString::fromUtf8("action_Save"));
        action_Save->setIcon(icon14);
        actionSave_as = new QAction(MainWindow);
        actionSave_as->setObjectName(QString::fromUtf8("actionSave_as"));
        actionSave_a_ll = new QAction(MainWindow);
        actionSave_a_ll->setObjectName(QString::fromUtf8("actionSave_a_ll"));
        actionSave_a_ll->setIcon(icon18);
        action_Run = new QAction(MainWindow);
        action_Run->setObjectName(QString::fromUtf8("action_Run"));
        QIcon icon24;
        icon24.addFile(QString::fromUtf8(":/resources/RES/tango/actions/media-playback-start.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_Run->setIcon(icon24);
        action_Debug = new QAction(MainWindow);
        action_Debug->setObjectName(QString::fromUtf8("action_Debug"));
        QIcon icon25;
        icon25.addFile(QString::fromUtf8(":/resources/RES/ffficons/bug_delete.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_Debug->setIcon(icon25);
        action_Parameters = new QAction(MainWindow);
        action_Parameters->setObjectName(QString::fromUtf8("action_Parameters"));
        QIcon icon26;
        icon26.addFile(QString::fromUtf8(":/resources/RES/ffficons/application_osx_terminal.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_Parameters->setIcon(icon26);
        action_Targets = new QAction(MainWindow);
        action_Targets->setObjectName(QString::fromUtf8("action_Targets"));
        QIcon icon27;
        icon27.addFile(QString::fromUtf8(":/resources/RES/ffficons/computer.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_Targets->setIcon(icon27);
        ...
        QIcon icon28;
        icon28.addFile(QString::fromUtf8(":/resources/RES/ffficons/cog.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_Project_options->setIcon(icon28);
        ...
        QIcon icon29;
        icon29.addFile(QString::fromUtf8(":/resources/RES/ffficons/chart_line_add.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionCreate_vector_path->setIcon(icon29);
        actionBuild = new QAction(MainWindow);
        actionBuild->setObjectName(QString::fromUtf8("actionBuild"));
        QIcon icon30;
        icon30.addFile(QString::fromUtf8(":/resources/RES/compile.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionBuild->setIcon(icon30);
        actionCreate_Shader = new QAction(MainWindow);
        actionCreate_Shader->setObjectName(QString::fromUtf8("actionCreate_Shader"));
        QIcon icon31;
        icon31.addFile(QString::fromUtf8(":/resources/RES/ffficons/contrast_high.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionCreate_Shader->setIcon(icon31);
        actionTarget_options = new QAction(MainWindow);
        actionTarget_options->setObjectName(QString::fromUtf8("actionTarget_options"));
        QIcon icon32;
        icon32.addFile(QString::fromUtf8(":/resources/RES/ffficons/computer_edit.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionTarget_options->setIcon(icon32);
        ...
        QIcon icon33;
        icon33.addFile(QString::fromUtf8(":/resources/RES/ffficons/package_go.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_Pack_project->setIcon(icon33);
        action_Preferences = new QAction(MainWindow);
        action_Preferences->setObjectName(QString::fromUtf8("action_Preferences"));
        action_Preferences->setIcon(icon28);
        ...
        QIcon icon34;
        icon34.addFile(QString::fromUtf8(":/resources/RES/ffficons/connect.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionSet_up_collaboration->setIcon(icon34);
        actionSkins = new QAction(MainWindow);
        actionSkins->setObjectName(QString::fromUtf8("actionSkins"));
        QIcon icon35;
        icon35.addFile(QString::fromUtf8(":/resources/RES/ffficons/folder_palette.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionSkins->setIcon(icon35);
        ...
        QIcon icon36;
        icon36.addFile(QString::fromUtf8(":/resources/RES/tree.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionProject_tree->setIcon(icon36);
        ...
        QIcon icon37;
        icon37.addFile(QString::fromUtf8(":/resources/RES/ffficons/image.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionImages->setIcon(icon37);
        ...
        QIcon icon38;
        icon38.addFile(QString::fromUtf8(":/resources/RES/ffficons/sound.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionSounds->setIcon(icon38);
        ...
        QIcon icon39;
        icon39.addFile(QString::fromUtf8(":/resources/RES/ffficons/application.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionScenes->setIcon(icon39);
        ...
        QIcon icon40;
        icon40.addFile(QString::fromUtf8(":/resources/RES/ffficons/brick.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionClasses->setIcon(icon40);
        ...
        QIcon icon41;
        icon41.addFile(QString::fromUtf8(":/resources/RES/ffficons/car.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionModels->setIcon(icon41);
        actionWorlds = new QAction(MainWindow);
        actionWorlds->setObjectName(QString::fromUtf8("actionWorlds"));
        actionWorlds->setCheckable(true);
        QIcon icon42;
        icon42.addFile(QString::fromUtf8(":/resources/RES/ffficons/world.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionWorlds->setIcon(icon42);
        actionFonts = new QAction(MainWindow);
        actionFonts->setObjectName(QString::fromUtf8("actionFonts"));
        actionFonts->setCheckable(true);
        QIcon icon43;
        icon43.addFile(QString::fromUtf8(":/resources/RES/ffficons/font.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionFonts->setIcon(icon43);
        ...
        QIcon icon44;
        icon44.addFile(QString::fromUtf8(":/resources/RES/ffficons/contrast.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionFilters->setIcon(icon44);
        actionAdd_Effect = new QAction(MainWindow);
        actionAdd_Effect->setObjectName(QString::fromUtf8("actionAdd_Effect"));
        QIcon icon45;
        icon45.addFile(QString::fromUtf8(":/resources/RES/ffficons/rainbow.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionAdd_Effect->setIcon(icon45);
        ...
        actionGraphics_effects->setIcon(icon45);
        ...
        QIcon icon46;
        icon46.addFile(QString::fromUtf8(":/resources/RES/ffficons/script.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionGlobal_functions->setIcon(icon46);
        ...
        searchboxLayout_4->setSpacing(3);
        ...
        menuResources->addAction(actionCreate_3D_scene);
        ...
        menuDeveloper->addAction(actionGameScript_tester);
        ...
        menuView->addAction(actionWorlds);
        menuView->addSeparator();
        ...
        viewToolbar->addAction(actionWorlds);
        viewToolbar->addSeparator();
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "pi|game CREATOR", 0, QApplication::UnicodeUTF8));
        ...
        actionPiGameCreator_help->setText(QApplication::translate("MainWindow", "piGameCreator help", 0, QApplication::UnicodeUTF8));
        ...
        actionVisit_piGameCreator_website->setText(QApplication::translate("MainWindow", "Visit piGameCreator website", 0, QApplication::UnicodeUTF8));
        ...
        actionCreate_2D_scene->setText(QApplication::translate("MainWindow", "Create 2D Scene", 0, QApplication::UnicodeUTF8));
        actionCreate_2D_scene->setShortcut(QApplication::translate("MainWindow", "Ctrl+Alt+S", 0, QApplication::UnicodeUTF8));
        actionCreate_3D_scene->setText(QApplication::translate("MainWindow", "Create 3D World", 0, QApplication::UnicodeUTF8));
        actionCreate_3D_scene->setShortcut(QApplication::translate("MainWindow", "Ctrl+Alt+3", 0, QApplication::UnicodeUTF8));
        ...
        actionGameScript_tester->setText(QApplication::translate("MainWindow", "GameScript tester", 0, QApplication::UnicodeUTF8));
        actionSkin_editor->setText(QApplication::translate("MainWindow", "Skin editor", 0, QApplication::UnicodeUTF8));
        actionFramework_editor->setText(QApplication::translate("MainWindow", "Framework editor", 0, QApplication::UnicodeUTF8));
        ...
        actionWorlds->setText(QApplication::translate("MainWindow", "Worlds", 0, QApplication::UnicodeUTF8));
